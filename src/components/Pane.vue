            ...
            <button
              ...
              @click="
                togglePinned({
                  ...
                  icon: icon,
                  resId: pinnable,
                  buildingStorageId: shortcutBuildingStorageId,
                })
              "
            >
              <i
                class="fas fa-fw fa-thumbtack"
                :class="{ 'text-normal': !isPinned(id) }"
              ></i>
            </button>
          </div>
...
export default {
  ...
  computed: {
    ...mapState(["displayPinnedItems"]),
    ...mapGetters(["isPinned"]),
  },
  methods: {
    ...mapMutations(["togglePinned"]),
  },
};
</script>
